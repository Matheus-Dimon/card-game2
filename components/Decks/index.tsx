...
<<<<<<< HEAD
  ...
  // Define um deck de cards para o jogador 2.
  export const player2Deck: CardType[] = [
    { id: 11, name: 'Mage', attack: 3, defense: 3, mana: 3, image: require('../../assets/images/mage.png'), type: 'mage' },
    { id: 12, name: 'Archer', attack: 2, defense: 5, mana: 2, image: require('../../assets/images/archer.png'), type: 'archer' },
    { id: 13, name: 'Warrior', attack: 4, defense: 2, mana: 3, image: require('../../assets/images/warrior.png'), type: 'warrior' },
    { id: 14, name: 'Mage', attack: 5, defense: 1, mana: 4, image: require('../../assets/images/mage.png'), type: 'mage' },
    { id: 15, name: 'Archer', attack: 3, defense: 3, mana: 2, image: require('../../assets/images/archer.png'), type: 'archer' },
    { id: 16, name: 'Mage', attack: 3, defense: 3, mana: 3, image: require('../../assets/images/mage.png'), type: 'mage' },
    { id: 17, name: 'Archer', attack: 2, defense: 5, mana: 2, image: require('../../assets/images/archer.png'), type: 'archer' },
    { id: 18, name: 'Warrior', attack: 4, defense: 2, mana: 3, image: require('../../assets/images/warrior.png'), type: 'warrior' },
    { id: 19, name: 'Mage', attack: 5, defense: 1, mana: 4, image: require('../../assets/images/mage.png'), type: 'mage' },
    { id: 20, name: 'Archer', attack: 3, defense: 3, mana: 2, image: require('../../assets/images/archer.png'), type: 'archer' },
=======
>>>>>>> 46181a126a910a7dcc38002793928aee2f14d162
  ];